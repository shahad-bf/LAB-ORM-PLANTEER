...
class Command(BaseCommand):
    help = 'Add sample plants with real data'
    ...
    def handle(self, *args, **options):
        ...
        plants_data = [
            {
                ...
                'category': 'flower',
                'is_edible': False,
                'image': 'static/images/baurry.jpg',
            },
            {
                'name': 'Moringa Tree',
                ...
                'category': 'tree',
                'is_edible': True,
                'image': 'static/images/lavender.jpg',
            },
            {
                'name': 'Pomegranate',
                ...
                'category': 'fruit',
                'is_edible': True,
                'image': 'static/images/strubbary.webp',
            },
            {
                'name': 'Sweet Basil',
        ...
        self.stdout.write(
            self.style.SUCCESS(f'Successfully added {len(plants_data)} plants')
        )
