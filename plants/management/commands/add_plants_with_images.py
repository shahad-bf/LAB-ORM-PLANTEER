...
class Command(BaseCommand):
    help = 'Add plants with images from static/images folder'

    def handle(self, *args, **options):
        # Clear existing plants
        Plant.objects.all().delete()
        
        # Sample plants data with images from static/images
        plants_data = [
            {
                'name': 'Oleander',
        ...
        self.stdout.write(
            self.style.SUCCESS(f'Successfully added {len(plants_data)} plants with images from static/images')
        )
